...
Sample project for the basic cours of the Talking About Testing online school
...
Run `npm test:mobile` (or `npm t` for the short version) to run the test in headless
